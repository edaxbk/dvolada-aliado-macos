//
//  AddNewDishController.swift
//  dVolada Aliado
//
//  Created by Miguel Ledezma on 08/04/21.
...
class AddNewDishController : UIViewController, UITextViewDelegate, UITableViewDelegate, ModifierAddListener{
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            confirmBtn.bottomAnchor.constraint(equalTo: viewDish.bottomAnchor,constant: -100)
        ])
...
extension AddNewDishController: UITextFieldDelegate {
